<?php
    ...
    //A sessão precisa ser inciada em cada página diferente
...
<head>
    ...
    <title>Acesso Completo</title>
</head>
<body>
    <h1>CRUD de Clientes</h1><br>
    ...
    <a href="cadastro.php">Adicionar Cliente</a><br><br>
